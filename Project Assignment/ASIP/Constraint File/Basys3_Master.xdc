...
##Pmod Header JB
#Sch name = ena
set_property PACKAGE_PIN A14 [get_ports {out7}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {out7}]
#Sch name = in1
set_property PACKAGE_PIN A16 [get_ports {out8}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {out8}]
#Sch name = in2
set_property PACKAGE_PIN B15 [get_ports {out9}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {out9}]
##Sch name = JB4
#set_property PACKAGE_PIN B16 [get_ports {JB[3]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {JB[3]}]
#Sch name = in3
set_property PACKAGE_PIN A15 [get_ports {out2}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {out2}]
#Sch name = in4
set_property PACKAGE_PIN A17 [get_ports {out3}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {out3}]
#Sch name = enb1
set_property PACKAGE_PIN C15 [get_ports {out1}]					
