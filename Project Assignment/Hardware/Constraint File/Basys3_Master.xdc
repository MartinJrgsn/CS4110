...
##Pmod Header JB
set_property PACKAGE_PIN A14 [get_ports {out5}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {out5}]
set_property PACKAGE_PIN A16 [get_ports {out6}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {out6}]
set_property PACKAGE_PIN B15 [get_ports {out11}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {out11}]
##Sch name = JB4
set_property PACKAGE_PIN B16 [get_ports {out12}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {out12}]
set_property PACKAGE_PIN A15 [get_ports {out4}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {out4}]
set_property PACKAGE_PIN A17 [get_ports {out10}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {out10}]
set_property PACKAGE_PIN C15 [get_ports {pwm}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {pwm}]
##Sch name = JB10 
set_property PACKAGE_PIN C16 [get_ports {pwm_trigger}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {pwm_trigger}]
 


##Pmod Header JC
set_property PACKAGE_PIN K17 [get_ports {out8}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {out8}]
set_property PACKAGE_PIN M18 [get_ports {out9}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {out9}]
set_property PACKAGE_PIN N17 [get_ports {out2}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {out2}]
set_property PACKAGE_PIN P18 [get_ports {out3}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {out3}]
set_property PACKAGE_PIN L17 [get_ports {out7}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {out7}]
set_property PACKAGE_PIN M19 [get_ports {out1}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {out1}]
#set_property PACKAGE_PIN P17 [get_ports {out6}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {out6}]
#set_property PACKAGE_PIN R18 [get_ports {pwm}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {pwm}]
